        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-gray-50 border-none rounded-xl focus:ring-2 focus:ring-primary-500 transition-all outline-none"
              autoFocus
            />
          </div>
            ...
            <div className="space-y-1 animate-in slide-in-from-top-2 duration-300">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full pl-10 pr-4 py-3 bg-gray-50 border-none rounded-xl focus:ring-2 focus:ring-primary-500 transition-all outline-none"
                />
              </div>
              <p className="text-[10px] text-gray-400 mt-1 ml-1 font-medium italic">Collaborators will need this password to enter.</p>
            </div>
          )}
